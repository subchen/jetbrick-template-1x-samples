...
public class DaoUtils {
    ...
    static {
        ...
        addBook(new BookInfo(1, "语文书", 1, 23.10, DateUtils.asDate("2000-01-01")));
        addBook(new BookInfo(2, "数学书", 1, 18.00, DateUtils.asDate("2001-02-01")));
        addBook(new BookInfo(3, "英语书", 1, 19.99, DateUtils.asDate("2002-03-01")));
        addBook(new BookInfo(4, "物理书", 1, 17.10, DateUtils.asDate("2003-04-01")));
        addBook(new BookInfo(5, "化学书", 2, 16.12, DateUtils.asDate("2004-05-01")));
        addBook(new BookInfo(6, "政治书", 2, 25.44, DateUtils.asDate("2005-06-01")));
        addBook(new BookInfo(7, "地理书", 2, 20.00, DateUtils.asDate("2006-07-01")));
        addBook(new BookInfo(8, "历史书", 3, 20.07, DateUtils.asDate("2007-08-01")));
        addBook(new BookInfo(9, "生物书", 3, 20.07, DateUtils.asDate("2008-09-01")));
    }
